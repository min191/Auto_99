...
const BlogDetail = () => {
    ...
    const fetchBlogDetail = async () => {
      try {
        const response = await fetch(
          `https://ngochieuwedding.io.vn/api/minh/news/${id}`
        );
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-white shadow-lg rounded-xl my-8">
      ...
      <p className="text-gray-600 text-lg sm:text-xl italic mb-6 font-light">
        {blog.description}
      </p>
      <div
